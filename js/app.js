import { compose, prop, find, propSatisfies, converge, subtract, curry, divide, multiply } from 'ramda';
...
function adaptCalendarResponse(json){
	...
	const calendar = compose(calculatePercentage, getFirstNotFullDayItem, prop('items'));
